...
#define EEPROM_SIZE  1024 // amount in Teensy 4.0, for 4.1 it is


// Keyboard / Manuals Settings:
#define NUM_MANUALS 1
#define KEYS_PER_MANUAL  61 
#define POLYPHONY  10      //number of keys the system can hold down at once
